...
public class Steps extends Thread{
	...
	public void startExecution() {
		...
		try{
			...
			utl.findAndClickElement(driver, "//*[@id=\"movie_player\"]/div[21]/div[2]/div[2]/button[3]", device+"_9.png", html);//settings button
			utl.findAndClickElement(driver, "//*[@id=\"ytp-id-18\"]/div/div/div[3]/div[1]", device+"_10.png", html);//click on quality
			utl.findAndClickElement(driver, "(//button[@aria-label='Settings'])[2]", device+"_11.png", html);
	...
	public void startExecutionMobile() {
		...
		try{
			...
			utl.findAndClickElement(driver, "//*[@id='header-bar']/header/div/ytm-menu/button", device+"_9.png", html);//settings button
			
			utl.findAndClickElement(driver, "//button[@class='menu-item-button' and text()='Playback Settings']",device+"_10.png", html);//click on quality
	
			utl.findAndClickElement(driver, "//ytm-select[@class='player-quality-settings']/select", device+"_11.png", html);
			
			utl.findAndClickElement(driver, "//ytm-select[@class='player-quality-settings']/select/option[contains(text(),'360p')]", device+"_12.png", html);
		
			utl.findAndClickElement(driver, "//button[contains(*,'OK')]", device+"_13.png", html);
